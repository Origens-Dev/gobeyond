...
function projectFiles(projectName, { tailwind }) {
  ...
  return {
    ...
    'go.mod': `module ${modulePath}\n\ngo 1.24.0\n\nrequire github.com/holbrookab/gobeyond v${GOBEYOND_VERSION}\n`,
    '.gitignore': `.gobeyond/\ndist/\nnode_modules/\n.env\n.env.local\n.env.*.local\n`,
...
function starterReadme(projectName) {
  return [
    ...
    '```bash',
    `go install github.com/holbrookab/gobeyond/cmd/gobeyond@v${GOBEYOND_VERSION}`,
    'pnpm install',
    'pnpm dev',
    '```', '',
