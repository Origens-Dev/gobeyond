...
Please report suspected vulnerabilities privately to the repository security
contact rather than opening a public issue. Include the affected revision,
route shape, request, impact, and a minimal reproduction when possible. Do not
include real credentials, cookies, personal data, or production secrets.
