...
// compilerEnvironment excludes deployment configuration and dotenv files. Local
// development and preview load their configuration only for the runtime process.
func compilerEnvironment() []string {
	...
	// Older published Vite plugins use this internal signal to disable dotenv.
	// It is unconditional and does not require any project configuration.
	return append(controlled, "GOFLAGS=-mod=readonly", "GOTOOLCHAIN=local", "GOBEYOND_PORTABLE_BUILD=1")
}
